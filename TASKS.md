1. Знайти автомобілі дорожчі 5000 // filter
1. Знайти авто зеленого кольору // find
1. Знайти усі спорткари// filtre
...
1. Порахувати загальну вартість всіх машин із кількістю на складі більше 2 і
   ціною менше 40 000.
