...
function onFormSubmit(e) {
  ...
  const userValue = refs.form.elements.query.value;
  const userSelect = refs.form.elements.options.value;
  const filtered = cars.filter(car =>
    car[userSelect].toLowerCase().includes(userValue.toLowerCase()),
  );
